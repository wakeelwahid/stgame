      ...
      <div className="top-section-container">
        ...
        <div className="announcement-marquee">
          <marquee behavior="scroll" direction="left" scrollamount="5">
            <span>🎉 रेफर और 5000 बोनस पाएं! कोड: WELCOME500 ,</span>
            <span> 💰 आज का जैकपॉट: ₹25,00,000 ,</span>
            <span> 🔥 नया गेम लॉन्च: डायमंड किंग , </span>
            <span> ⭐ विशेष ऑफर: पहले डिपॉजिट पर 100% बोनस.</span>
            <span> 🔥 नया गेम लॉन्च: डायमंड किंग , </span>
            <span> ⭐ विशेष ऑफर: पहले डिपॉजिट पर 100% बोनस.</span>
          </marquee>
        </div>
